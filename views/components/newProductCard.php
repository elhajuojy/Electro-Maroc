<a href="/products?id=2">
    <div class="new-product-card product-card w-72 max-w-[234px] hover:shadow hover:bg-gray-50 hover:cursor-pointer p-2 rounded ease-in duration-300  grid justify-center gap-4 m-auto mb-4">
        ...
        <div class="product-img m-auto">
            <img src="assets/images/products/tablet.png" alt="">
        </div>
        <div class="product-rate">
            ...
            <div class="product-price grid gap-1 mt-2">
                <p class="old-price line-through text-color-5">$499.00</p>
                <p class="new-price text-xl">$499.00</p>
